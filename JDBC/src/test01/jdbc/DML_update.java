	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			pstmt.setString(2, msg);  // 2 는 sql에서 두번째 ? 를 말한다. 두번째 ? 에 msg 를 넣어라.
			pstmt.setString(3, no);   // 3 은 sql에서 세번째 ? 를 말한다. 세번째 ? 에 no 를 넣어라. 
			...
			if(n==1) {
				...
				System.out.println(">> 변경하시려는 글번호는 존재하지 않는 글번호 입니다. <<");
			}
